...
filepath = r'C:\Users\Sahil\Desktop\IT\SEM 7\Final yr project\Plant-Leaf-Disease-Prediction-main\model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join(r'C:\Users\Sahil\Desktop\IT\SEM 7\Final yr project\Plant-Leaf-Disease-Prediction-main\static\upload/', filename)
        file.save(file_path)
